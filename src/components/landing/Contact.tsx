...
const Contact = () => {
    ...
    return (
        <div>
            ...
            <section className="mb-24 mt-10" data-aos="fade-up">
                ...
                <div className=" px-6 md:px-12">
                    <div
                        className="block rounded-lg mx-auto bg-[hsla(0,0%,100%,0.8)] px-6 py-12 drop-shadow-2xl  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
              ...
              <textarea
                  ...
                  id="exampleFormControlTextarea1" rows="3"></textarea>
                                    ...
                                    <button type="button"
                                            className="mb-6 w-full rounded bg-indigo-600 hover:bg-indigo-500 text-white px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal   lg:mb-0">
                                        Send
                                    </button>
                                </form>
                            </div>
